...
<div>
    <form action="{{ route('clientes.index') }}" method="get">
        ...
        <a href="{{ route('cadastrar.cliente') }}" type="button" class="btn btn-success float-end btn-group-sm"> 
            Incluir Cliente
        </a>
    </form>
          ...
          <tbody>
            @foreach ($findCliente as $cliente)
                <tr>
                    ...
                    <td>
                        <a href="{{route('atualizar.cliente', $cliente->id)}}" class="btn btn-secondary btn-sm">
                            Editar
                        </a>
